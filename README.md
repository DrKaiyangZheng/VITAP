...
```
cd VITAP
./scripts/VITAP upd --vmr ./ICTV_VMR_MSL38/ICTV_VMR-MSL38_IMGVR_221222.csv -o ./ICTV_VMR_MSL38/ICTV_VMR-MSL38_IMGVR_221222_reformat.csv
```
...
```
cd VITAP
./VITAP assignment -i test.fasta -d ./DB_20240115/ -o test_result
```
